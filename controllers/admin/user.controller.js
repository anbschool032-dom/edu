...
//       // 1. Create User Core
//       await User.create({
//         id: userId, email, password: hashedPassword, role_name, status: 'unverified',
//         created_by: req.user ? req.user.id : null,
//       }, { transaction: t });

//       // 2. Create Profile based on Role
//       if (role_name === 'admin') {
//         await Admin.create({ id: uuidv4(), user_id: userId, first_name, last_name, phone, profile_image }, { transaction: t });
//       } else if (role_name === 'user') {
//         await AccUser.create({ id: uuidv4(), user_id: userId, first_name, last_name, phone, gender, dob, types_user, institution_name, profile_image }, { transaction: t });
...
//       // ✅ 4. COMMIT TRANSACTION (ទិន្នន័យចូល Database ជោគជ័យ)
//       await t.commit();

//       // ============================================================
//       // 🔥 ដំណោះស្រាយបញ្ហា LOADING:
//       // យើងឆ្លើយតបទៅ Frontend ភ្លាមៗ មិនបាច់ចាំ Email ទេ
//       // ============================================================
//       res.status(201).json({ 
//         message: `${role_name} created successfully! Check email for verification.` 
//       });

//       // ============================================================
//       // 🚀 BACKGROUND TASKS (ធ្វើការនៅខាងក្រោយ មិនអោយ User ចាំ)
//       // ============================================================
...
//       } catch (tgError) { 
//         console.error("Background Telegram Error:", tgError.message); 
//       }

//       // B. ផ្ញើ Email (មិនប្រើ await ដើម្បីកុំអោយ Block)
...
//     // បើមាន Error ក្នុងផ្នែកបង្កើត User ទើបយើងប្រាប់ទៅ Frontend ថា Error
//     if (!res.headersSent) {
...
//             { model: db.Position, as: 'position' }, // Assuming Position is loaded in db
//             { model: db.Industry, as: 'industry' }  // Assuming Industry is loaded in db
//           ]
//         },
...
//     // ... (Keep your initial admin code here if needed)
